...
### 🎯 闯关模块（v3.5 新增）
- **学科地图**：语文/数学/英语三大学科，每日闯关
- **AI 出题**：基于 327 本教材 PDF 生成的知识图谱 + 英语课程标准，动态生成题目
- **Duolingo 风格**：进度条、即时反馈、星级评价
- **奖励系统**：龙币 + 经验 + 宝箱（普通/黄金/传奇）
- **错题本**：自动收集错题，诊断薄弱知识点
- **题库规模**：4,614 题（语文 1,148 + 数学 2,598 + 英语 868）
